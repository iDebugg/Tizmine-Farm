    ...
    <section id="Services" className="py-12 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-green-700 italic text-4xl font-bold">
            Our Services
          </h2>
          <p className="text-lg text-gray-600 mt-2">
            High-quality poultry, livestock, and fresh produce delivered with
            care.
          </p>
        </div>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <button className="mt-4 w-full px-4 py-2 bg-green-700 text-white text-sm font-semibold rounded hover:bg-green-600 transition-colors">
                <a href="https://wa.link/rydauo">Contact to Order</a>
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <p className="text-green-500 font-semibold mt-4">Price Vary</p>
              <button className="mt-4 w-full px-4 py-2 bg-green-700 text-white text-sm font-semibold rounded hover:bg-green-600 transition-colors">
                <a href="https://wa.link/ctoy4j">Contact to Order</a>
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <p className="text-green-500 font-semibold mt-4">Price Vary</p>
              <button className="mt-4 w-full px-4 py-2 bg-green-700 text-white text-sm font-semibold rounded hover:bg-green-600 transition-colors">
                <a href="https://wa.link/en58u0">Contact to Order</a>
              </button>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <p className="text-green-500 font-semibold mt-4">Price Vary</p>
              <button className="mt-4 w-full px-4 py-2 bg-green-700 text-white text-sm font-semibold rounded hover:bg-green-600 transition-colors">
                <a href="https://wa.link/a8npi6"> Contact to Order</a>
              </button>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            <img src={fish} alt="fish" className="w-full h-48 object-cover" />
            <div className="p-4">
              ...
              <p className="text-green-500 font-semibold mt-4">Price Vary</p>
              <button className="mt-4 w-full px-4 py-2 bg-green-700 text-white text-sm font-semibold rounded hover:bg-green-600 transition-colors">
                <a href="https://wa.link/1wdnnn"> Contact to Order</a>
              </button>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <p className="text-green-500 font-semibold mt-4">Price Vary</p>
              <button className="mt-4 w-full px-4 py-2 bg-green-700 text-white text-sm font-semibold rounded hover:bg-green-600 transition-colors">
                <a href="https://wa.link/cbkr5n">Contact to Order</a>
              </button>
            </div>
          </div>
        </div>
